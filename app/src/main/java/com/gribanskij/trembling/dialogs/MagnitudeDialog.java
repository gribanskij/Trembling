...
public class MagnitudeDialog extends DialogFragment {
    ...
    public static DialogFragment newInstance(int checkedItem) {
        DialogFragment fragment = new MagnitudeDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.magnitude_title)
                .setSingleChoiceItems(R.array.min_magnitude_labels, choice, (dialogInterface, i) -> {
                ...
                .setPositiveButton(R.string.ok, (dialog, id) -> {
                    ...
                    mListener.onDialogPositiveClick(MagnitudeDialog.this, choice, 0, 0, 0);


                })
                .setNegativeButton(R.string.cancel, (dialog, id) -> {

                    mListener.onDialogNegativeClick(MagnitudeDialog.this, id);
